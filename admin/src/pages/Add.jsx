          ...
          <div className='w-[400px] h-[50px] text-[25px] md:text[40px] text-white'>Add Product Page</div>
           ...
           <div className='w-[80%] flex items-center gap-[10px] flex-wrap'>
            <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'>
              ...
              <select name="" id="" className='bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px]' onClick={(e)=>setCategory(e.target.value)} >
            ...
            <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'>
              ...
              <select name="" id="" className='bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px]'onClick={(e)=>setSubCategory(e.target.value)} >
